...
func TestCaseSensitivity(t *testing.T) {
	validSQL := []struct {
		...
		input: "create table sheng1",
	}, {
		input:  "create index b on sheng2",
		output: "alter table A",
	}, {
		input:  "alter table sheng3 foo",
		output: "alter table A",
	}, {
		...
		input:  "alter table sheng4 rename to B",
		output: "rename table A B",
	}, {
		...
		input: "select a from aaa where id>0",
	}, {
		input: "select A as bbb from ddd",
	}, {
		input: "select B.* from ccc",
	}, {
